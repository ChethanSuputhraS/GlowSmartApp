...
BOOL isDashConnect, isNonConnectScanning, isDashScanning, isConnectionIssue, isfromBridge, isfromAddDevice, isChanged, globalConnStatus, isAlldevicePowerOn, isOnAddGroup,isTimeSetSuccess,isFeedbackOpen,isFromFactoryRest;
...
NSMutableArray *arrConnectedDevices;NSMutableArray * arrGlobalDevices;
