...
//    else
    {
//        NSString * strDeletInstall = [NSString stringWithFormat:@"select * from Device_Table"];
...
//        globalPeripheral = newPeripheral;
    ...
    {
        isDashConnect = NO;
        [[NSNotificationCenter defaultCenter] postNotificationName:@"DashboardConnectionNotify" object:nil];
    }
}
