...
- (void)createBoxSubviews
{
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 0.0f, DEVICE_WIDTH, 50.0f)];
    titleLabel.text = NSLocalizedString(@"Your Feedback!!!", nil);
    ...
    UILabel * lblBody = [[UILabel alloc] initWithFrame:CGRectMake(10.0f, 130.0f, DEVICE_WIDTH-20, 30.0f)];
