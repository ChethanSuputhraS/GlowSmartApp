...
@interface DeviceDetailVC ()<FCAlertViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,CBCentralManagerDelegate, SFSpeechRecognizerDelegate>
{
    BOOL isVoiceCreated;
